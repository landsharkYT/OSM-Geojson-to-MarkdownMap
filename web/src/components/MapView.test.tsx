...
describe('MapView', () => {
  it('renders token labels for promoted features', () => {
    render(<MapView model={rivertown} selected={null} onSelect={() => {}} layers={ALL} />)
  ...
  it('selects a feature on click', () => {
    ...
    render(<MapView model={rivertown} selected={null} onSelect={onSelect} layers={ALL} />)
  ...
  it('hides token labels when the tokens layer is off', () => {
    render(<MapView model={rivertown} selected={null} onSelect={() => {}} layers={{ ...ALL, tokens: false }} />)
